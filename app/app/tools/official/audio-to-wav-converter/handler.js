...
// Resolve the output WAV file name, ensuring uniqueness when duplicates exist.
...
function buildIdleResponse(fileCount) {
  const label = fileCount ? `Ready to convert ${fileCount} audio file(s) to .wav.` : "Upload audio files to begin.";
  return {
...
function buildEmptyResponse() {
  return {
    convertOutput  : buildPlaceholderHtml("Upload audio files to generate WAV downloads."),
    convertError   : "",
